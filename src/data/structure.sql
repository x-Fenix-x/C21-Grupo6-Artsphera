CREATE DATABASE  IF NOT EXISTS `artesphera_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `artesphera_db`;
...
CREATE TABLE `items` (
  ...
  KEY `productId` (`productId`),
  KEY `orderId` (`orderId`),
  CONSTRAINT `items_ibfk_1` FOREIGN KEY (`productId`) REFERENCES `products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `items_ibfk_2` FOREIGN KEY (`orderId`) REFERENCES `orders` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2023-12-17 13:20:22
